...
arm-linux-gnueabi-g++ receivingNode.cpp message_helper.cpp network_organizer.cpp emulated_nodes/coordinator_node.cpp emulated_nodes/worker_node.cpp -g -static -o receivingNodeArm
echo "------------------------------------------Compiling sendingNode---------------------------------------------"
arm-linux-gnueabi-g++ sendingNode.cpp message_helper.cpp network_organizer.cpp emulated_nodes/coordinator_node.cpp emulated_nodes/worker_node.cpp -g -static -o sendingNodeArm
