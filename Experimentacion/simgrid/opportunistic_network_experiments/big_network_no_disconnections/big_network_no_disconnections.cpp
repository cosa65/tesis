...
static void map_reduce_coordinator_host_setup(std::vector<std::string> args) {
	...
	workers.push_back("Node49");
	workers.push_back("Node50");
	workers.push_back("Node51");
	workers.push_back("Node52");
	workers.push_back("Node53");
	workers.push_back("Node54");
	workers.push_back("Node55");
	workers.push_back("Node56");
	workers.push_back("Node57");
	workers.push_back("Node58");
	workers.push_back("Node59");
	workers.push_back("Node60");
	workers.push_back("Node61");
	workers.push_back("Node62");
	workers.push_back("Node63");
	workers.push_back("Node64");
	workers.push_back("Node65");
	workers.push_back("Node66");
	workers.push_back("Node67");
	workers.push_back("Node68");
	workers.push_back("Node69");
	workers.push_back("Node70");
	workers.push_back("Node71");
	workers.push_back("Node72");
	workers.push_back("Node73");
	workers.push_back("Node74");
	workers.push_back("Node75");
	workers.push_back("Node76");
	workers.push_back("Node77");
	workers.push_back("Node78");
	workers.push_back("Node79");
	workers.push_back("Node80");
	workers.push_back("Node81");
	workers.push_back("Node82");
	workers.push_back("Node83");
	workers.push_back("Node84");
	workers.push_back("Node85");
	workers.push_back("Node86");
	workers.push_back("Node87");
	workers.push_back("Node88");
	workers.push_back("Node89");
	workers.push_back("Node90");
	workers.push_back("Node91");
	workers.push_back("Node92");
	workers.push_back("Node93");
	workers.push_back("Node94");
	workers.push_back("Node95");
	workers.push_back("Node96");
	workers.push_back("Node97");
	workers.push_back("Node98");
